...
path_train_audio = "../data_train/"
path_test_audio = "../data_test/"
path_csvfiles = "./"
...
train = pd.read_csv(path_csvfiles+'train-test.csv')
...
train_data = train_data['fname'].apply(get_mfcc, path=path_train_audio)
print('done loading train mfcc')
test_data = test_data['fname'].apply(get_mfcc, path=path_test_audio)
