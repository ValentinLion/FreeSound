...
path_audio_train = "../FreeSoundData/audio_train/"
path_audio_test = "../FreeSoundData/audio_test/"

#description.description(pd.read_csv("train.csv", sep=","))

if (useAudioAnalysCSV):
    df_dataframe = pd.read_csv("csv/train_analys.csv", sep=",")
    df_test = pd.read_csv("csv/sample_submission_analys.csv", sep=",")
    ...
    df_test.to_csv("csv/sample_submission_analys.csv", sep=",")
